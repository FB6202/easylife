...
export class DocumentsComponent {
  ...
  readonly documents = signal<Document[]>([
    {
      ...
      description: 'Q4 financial report with full P&L breakdown.',
      filePath: '/docs/q4-financial.pdf',
      fileType: 'pdf',
    ...
    },
    {
      ...
      description: 'Design principles and component guidelines.',
      filePath: '/docs/design-manifesto.docx',
      fileType: 'docx',
    ...
    },
    {
      ...
      filePath: '/docs/brand-assets.png',
      fileType: 'png',
    ...
    },
    {
      ...
      description: 'Compiled survey results from Q3 2024.',
      filePath: '/docs/feedback.xlsx',
      fileType: 'xlsx',
    ...
    },
    {
      ...
      description: 'Full demo walkthrough for Acme Corp.',
      filePath: '/docs/demo.mp4',
      fileType: 'mp4',
    ...
    {
      id: 6,
      title: 'Podcast Interview Raw',
      description: 'Unedited recording from the ProductPeople podcast.',
      filePath: '/docs/podcast.mp3',
      fileType: 'mp3',
      fileSizeBytes: 87000000,
      accessType: 'PRIVATE',
    ...
    },
    {
      ...
      description: 'Before and after renovation pictures.',
      filePath: '/docs/renovation.jpg',
      fileType: 'jpg',
  ...
  onFilterApply(values: FilterValues) {
    ...
    console.log('Document filter applied:', values);
  }
